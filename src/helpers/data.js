...
const comments = [
    {
        ...
        text: `A clean and simple interface to organize your favourite websites. Open a new 
...
const form = {
    title: '35,00 + ALREADY JOINED',
    text: `Stay up-to-date with what we're doing`
}

export { comments, extensions, questions, form, features }